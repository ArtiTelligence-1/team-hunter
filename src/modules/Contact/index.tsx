                        ...
                        <form action="#">
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                    <textarea className="textarea_prop" placeholder="Message"></textarea>
